...
function App() {
  ...
  const handleLogin = () => {
    // Mock login - in a real app, this would show a login modal/form
    setCurrentUser(mockUser);
    alert('模擬登入成功！你現在可以發布貼文和留言了。');
  };

  const handleRegister = () => {
    // Mock register - in a real app, this would show a registration modal/form
    alert('註冊功能將連接到後端 API');
  };
